...
class ExportMagento2xProducts(models.TransientModel):
    ...
    def set_default_magento_data(self):
        ...
        if channel_id.channel=='magento2x' and channel_id.default_product_set_id:
    ...
    def magento2x_get_store_category_ids(self,template_id,channel_id):
        ...
        elif self.channel_id.channel_default_product_categ_id:
            res= [self.channel_id.channel_default_product_categ_id.store_category_id]
        if mapped_ids:
    ...
    def magento2x_get_product_data(self,_type,product_id,channel_id,
        ...
        product_set_id = self.default_product_set_id or channel_id.default_product_set_id
    ...
    def magento2x_send_product_data(self, sdk, template_id ,channel_id, product_set_id,operation = 'export'):
        ...
        if not(template_id.attribute_line_ids):
            ...
            if match:
                if exp_res.get('update_simple',False) == "done" or exp_res.get('status'):
                    match.need_sync = "no"
